...
public class ModTiers {
    public static final ForgeTier AURUS_STAGEONE = new ForgeTier(2,723, 1.5f,
                    2f,22, BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(ModItems.AURUS_INGOT.get()));

    public static final ForgeTier AURUS_STAGETWO = new ForgeTier(2, 1378, 1.8f,
            2f, 23, BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(ModItems.EMPOWERED_AURUS_INGOT.get()));

    public static final ForgeTier AURUS_LASTSTAGE = new ForgeTier(3, 2048, 2f,
